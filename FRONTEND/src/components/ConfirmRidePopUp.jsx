...
const ConfirmRidePopUp = (props) => {
    ...
    const handleClick = async()=>{
        ...
        if(response.status ===200){
            ...
            navigate('/captain/home',{state:{ride:props.ride}})
        }
    }
    return (
        <div>
            ...
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-6 w-full'>
                    <form >
                        ...
                        <Link className='w-full mt-5 text-lg flex justify-center bg-green-600 text-white font-semibold p-3 rounded-lg' to='/captain/riding'>Confirm</Link>
                        <button onClick={() => {
                            handleClick
